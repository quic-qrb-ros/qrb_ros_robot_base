...
#include "qrb_ros_robot_base_msgs/msg/get_battery_state.hpp"
...
private:
  ...
  rclcpp::Subscription<qrb_ros_robot_base_msgs::msg::GetBatteryState>::SharedPtr get_battery_sub_;
  ...
  void get_battery_state_callback(
